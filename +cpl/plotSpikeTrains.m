function [byChannel,SPK] = plotSpikeTrains(behaviorData,external_events,varargin)
%PLOTSPIKETRAINS  Plot all rasters for spike trains in a given BLOCK
%
%  cpl.plotSpikeTrains;
%  cpl.plotSpikeTrains(behaviorData);
%  cpl.plotSpikeTrains(behaviorData,external_events,'NAME',value,...);
%  cpl.plotSpikeTrains([],[],'NAME',value,...);
%
%  byChannel =
%     cpl.plotSpikeTrains(behaviorData,external_events,'NAME',value,...);
