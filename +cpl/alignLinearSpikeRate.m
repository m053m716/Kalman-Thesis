function [Rate,T,tvec] = alignLinearSpikeRate(rates,behaviorData,varargin)
%ALIGNLINEARSPIKERATE   Align rates from linear estimator to behavior
%
%  Rate = cpl.alignLinearSpikeRate(rates,behaviorData);
%  Rate = cpl.alignLinearSpikeRate(rates,behaviorData,'NAME',value,...);
%  [Rate,T,tvec] = cpl.ALIGNLINEARSPIKERATE(___);
%
