function [avg,t,err,D] = getRawAverage(data,fs,ts,varargin)
%GETRAWAVERAGE Average using aligned times
%
%  avg = cpl.getRawAverage(data,idx);
%  [avg,t,err] = cpl.getRawAverage(data,idx,'NAME',value,...);
%  
%  --------
%   INPUTS
%  --------
