function [X,fs,SPK] = loadSpikeTrains(varargin)
%LOADSPIKETRAINS  Load spike trains from BLOCK structure
%
%  [X,fs,SPK] = cpl.loadSpikeTrains;
%  [X,fs,SPK] = cpl.loadSpikeTrains('NAME',value,...);
%
%  --------
%   INPUTS
%  --------
