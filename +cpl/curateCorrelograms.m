function curateCorrelograms(corr_data,varargin)
%CURATECORRELOGRAMS  Manually curate inhibitory/excitatory interactions.
%
%  cpl.curateCorrelograms(rel,'NAME',value,...)
%
%  --------
%   INPUTS
%  --------
%  corr_data    :     Struct from cpl.GETXCORR
%
