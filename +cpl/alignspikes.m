function [byChannel,byTrial,tVec] = alignspikes(X,idx,varargin)
%ALIGNSPIKES   Align spikes from array X using external alignment t
%
%    [byChannel,byTrial,tVec] = cpl.alignspikes(X,idx,'NAME',value,...);
%
%  --------
%   INPUTS
%  --------
...
if CLIP_BINS && clip_ok
   byChannel = cpl.clipbins(byChannel);
end
