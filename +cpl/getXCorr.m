function corr_data = getXCorr(varargin)
%GETXCORR   Get cross correlations of all spike trains in a block.
%
%  corr_data = cpl.getXCorr;
%  corr_data = cpl.getXCorr('NAME',value,...);
%
%  --------
%   INPUTS
%  --------
