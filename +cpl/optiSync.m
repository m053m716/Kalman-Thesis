function [tEvent,sync,user] = optiSync(varargin)
%OPTISYNC   Get event times from synchronized optiTrack record.
%
%  tEvent = cpl.optiSync;
%  tEvent = cpl.optiSync('NAME',value,...);
%
%  --------
%   INPUTS
%  --------
...
COMBINE = true;   % Flag to automatically prompt for cpl.getButtonSync info
...
if COMBINE
   ...
   tEvent = cpl.getButtonSync(nFrames,frameRate,tEvent);
end
